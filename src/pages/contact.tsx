      ...
      <div className="bg-white rounded-3xl shadow-xl flex flex-col md:flex-row gap-12 items-center p-10">
        <div className="flex-1 w-full">
          ...
          <p className="text-lg text-gray-600 mb-8 text-center md:text-left">
            Have a question, suggestion, or want to partner with us? Fill out the form below or email us at <a href="mailto:info@tishyafoods.com" className="text-green-700 underline">info@tishyafoods.com</a>.
          </p>
